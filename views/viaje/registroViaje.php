...
<?php if(isset($_SESSION['analisisMantenimiento']) && $_SESSION['analisisMantenimiento'] == 'complete'): ?>
    <strong class="alert_green">El vehiculo no necesita mantenimiento</strong>
<?php elseif(isset($_SESSION['analisisMantenimiento']) && $_SESSION['analisisMantenimiento'] == 'failed'): ?>
    <strong class="alert_red">No puede agregar un viaje con ese vehiculo porque necesita mantenimiento.</strong>
<?php endif; ?>
<?php Utils::deleteSession('analisisMantenimiento'); ?>
...
<div class="w3-container">
    <h1 class="w3-center">Registrar Viaje</h1>
